...
class BasicUser(Base):
    ...
    state = Column(SmallInteger, nullable=False, doc=u"""1@NORMAL#正常;2@FROZEN#冻结;9@DELETED#删除""")
...
class VlssSceneGroup(Base):
    ...
    state = Column(SmallInteger, nullable=False, doc=u"""1@NORMAL#正常;9@DELETED#删除""")
...
class VlssSceneItem(Base):
    ...
    state = Column(SmallInteger, nullable=False, doc=u"""1@SHOW#显示;2@HIDE#隐藏;9@DELETED#删除""")
