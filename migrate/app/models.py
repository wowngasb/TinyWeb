...
class VlssApp(Base):
    ...
    active_group_id = Column(Integer, nullable=False, server_default=text("'0'"))   #激活的场景组id
    active_template_id = Column(Integer, nullable=False, server_default=text("'0'"))   #激活的场景模版id
