...
<div class="demo-content">
    ...
    <div class="control-group">
        <a class="button button-success array_btn" target="new"
           href="<?= \TinyWeb\Request::urlTo($request, ['Deploy', 'runCrontab', 'develop'], ['script' => 'PerMinuteTask.php']) ?>">每分钟任务</a>
        <a class="button button-success array_btn" target="new"
           href="<?= \TinyWeb\Request::urlTo($request, ['Deploy', 'runCrontab', 'develop'], ['script' => 'PerDayTask.php']) ?>">每日任务</a>
        <a class="button button-success array_btn" target="new"
           href="<?= \TinyWeb\Request::urlTo($request, ['Deploy', 'buildApiModJs', 'develop'], ['dev_debug' => 1,]) ?>">编译API</a>
        <a class="button button-success array_btn" target="new"
           href="<?= \TinyWeb\Request::urlTo($request, ['Deploy', 'phpInfo', 'develop']) ?>">phpInfo</a>
...
<script type="text/javascript">
    BUI.use('bui/form', function (Form) {
        ...
        BUI.Form.Group.Select.addType('custom1', {
            url: "<?=\TinyWeb\Request::urlTo($request, ['syslog', 'getmethodlist', 'develop'])?>",
            root: {
                id: '0',
        ...
        $('#api_method').change(function () {
            ...
            var api_url = "<?=\TinyWeb\Request::urlTo($request, ['syslog', 'getparamlist', 'develop'])?>";
            $.ajax({
                type: "GET",
                url: api_url,
